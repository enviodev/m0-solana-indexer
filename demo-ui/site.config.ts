...
export const siteConfig: SiteConfig = {
  ...
  hero: {
    ...
    title: "Yield index",
    query:
      "query { Latest: IndexUpdate(order_by: {slot: desc}, limit: 1) { index } Series: IndexUpdate(order_by: {slot: asc}) { time index } }",
    path: "Latest.index",
    format: "bigintDecimals",
    decimals: 12,
    caption: "Latest index propagated from Ethereum via the Portal bridge",
    spark: { yPath: "Series.index" },
    sample: {
      Latest: [{ index: "1090699442016" }],
      Series: [
        { time: 1754400000, index: "1090612376394" },
        { time: 1754410000, index: "1090624979749" },
        { time: 1754420000, index: "1090637541765" },
        { time: 1754430000, index: "1090649882840" },
        { time: 1754440000, index: "1090662320792" },
        { time: 1754450000, index: "1090674565408" },
        { time: 1754460000, index: "1090687293870" },
        { time: 1754470000, index: "1090699442016" },
      ],
    },
  },
  ...
  widgets: [
    ...
    },
    {
      ...
      query: "query { IndexUpdate(order_by: {slot: asc}) { time index } }",
      xPath: "IndexUpdate.time",
      yPath: "IndexUpdate.index",
